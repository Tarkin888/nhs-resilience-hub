...
const StatusFooter = memo(({
  ...
  return <footer className="mt-12 bg-gradient-to-r from-muted/50 to-muted border-t-2 border-border py-6">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        {/* Status indicators */}
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-6 text-sm" aria-label="System status indicators">
        ...
        <div className="text-center mb-4">
          <p className="text-sm text-muted-foreground">
            ...
            <a href="mailto:demo@example.com" className="text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded">
              demo@example.com
            </a>
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 pt-4 border-t border-border text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            <Link to="/privacy" className="hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded">
              Privacy
            </Link>
            <Link to="/accessibility" className="hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded">
              Accessibility
            </Link>
            <button onClick={onOpenMethodology} className="hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded">
              Methodology
            </button>
          </div>
        </div>
