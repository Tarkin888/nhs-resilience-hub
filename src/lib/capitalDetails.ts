    ...
    kris: [
      {
        ...
        currentValue: '£12.3M',
        trend: 'stable',
        target: 'Target: £15M+ (82% of target)',
  ...
  operational: {
    ...
    kris: [
      ...
      },
      {
        ...
        currentValue: '2,340',
        trend: 'declining',
        target: 'Target: <1,500 | NHS avg: 1,850',
    ...
    kris: [
      {
        ...
        trend: 'declining',
        target: 'Target: <50 FTE | NHS avg: 85 FTE',
      ...
      },
      {
        ...
        currentValue: '5.2%',
        trend: 'declining',
        target: 'Target: <4.5% | NHS avg: 5.2%',
        commentary: 'At NHS England average',
        dataSource: 'ESR System',
      },
      {
  ...
  reputational: {
    ...
    kris: [
      ...
      },
      {
        ...
        currentValue: 'Good',
        trend: 'stable',
        target: 'Last: Jul 2023 | Next: Q2 2025',
      ...
      },
      {
        ...
        currentValue: '+42%',
        trend: 'improving',
        target: 'Target: >+30% | Sector avg: +18%',
    ...
    kris: [
      {
        ...
        currentValue: '-8% YoY',
        trend: 'improving',
        target: 'Target: -10% YoY | NHS avg: -4%',
      ...
      },
      {
        ...
        trend: 'declining',
        target: 'Target: B Rating | NHS avg: C',
